...
describe GalleriesController do
  ...
  let(:valid_attributes) { { "photo_file_name" => "MyString" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved gallery as @gallery" do
        ...
        post :create, {:gallery => { "photo_file_name" => "invalid value" }}, valid_session
        assigns(:gallery).should be_a_new(Gallery)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested gallery" do
        ...
        Gallery.any_instance.should_receive(:update).with({ "photo_file_name" => "MyString" })
        put :update, {:id => gallery.to_param, :gallery => { "photo_file_name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the gallery as @gallery" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Gallery.any_instance.stub(:save).and_return(false)
        put :update, {:id => gallery.to_param, :gallery => { "photo_file_name" => "invalid value" }}, valid_session
        assigns(:gallery).should eq(gallery)
      end
